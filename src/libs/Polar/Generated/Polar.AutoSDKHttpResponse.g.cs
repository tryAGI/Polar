...
namespace Polar
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::Polar.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::Polar.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::Polar.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::Polar.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::Polar.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::Polar.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::Polar.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::Polar.ApiException exception)
        ...
        private static global::Polar.AutoSDKRequestOptions CloneRequestOptions(
            global::Polar.AutoSDKRequestOptions? source)
        {
            var clone = new global::Polar.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
