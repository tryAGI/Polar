...
namespace Polar
{
    public partial class DailyActivityClient
    {
        ...
        private static readonly global::Polar.EndPointSecurityRequirement s_GetActivityWithoutTransactionSecurityRequirement0 =
        ...
        private static readonly global::Polar.EndPointSecurityRequirement[] s_GetActivityWithoutTransactionSecurityRequirements =
            new global::Polar.EndPointSecurityRequirement[]
            {                s_GetActivityWithoutTransactionSecurityRequirement0,
            };
        partial void PrepareGetActivityWithoutTransactionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.DateTime date,
            ref bool? steps,
            ref bool? activityZones,
            ref bool? inactivityStamps);
        partial void PrepareGetActivityWithoutTransactionRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessGetActivityWithoutTransactionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetActivityWithoutTransactionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Polar.ActivitySummaryWithAllSamples> GetActivityWithoutTransactionAsync(
            global::System.DateTime date,
            bool? steps = default,
        ...
        {
            var __response = await GetActivityWithoutTransactionAsResponseAsync(
                date: date,
                steps: steps,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Polar.AutoSDKHttpResponse<global::Polar.ActivitySummaryWithAllSamples>> GetActivityWithoutTransactionAsResponseAsync(
            global::System.DateTime date,
            bool? steps = default,
            bool? activityZones = default,
            bool? inactivityStamps = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetActivityWithoutTransactionArguments(
            ...
            var __authorizations = global::Polar.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetActivityWithoutTransactionSecurityRequirements,
                operationName: "GetActivityWithoutTransactionAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Polar.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Polar.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetActivityWithoutTransactionAsync",
                                pathTemplate: "$\"/v3/users/activities/{date}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetActivityWithoutTransactionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Polar.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetActivityWithoutTransactionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Polar.ActivitySummaryWithAllSamples.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Polar.AutoSDKHttpResponse<global::Polar.ActivitySummaryWithAllSamples>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Polar.ActivitySummaryWithAllSamples.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
