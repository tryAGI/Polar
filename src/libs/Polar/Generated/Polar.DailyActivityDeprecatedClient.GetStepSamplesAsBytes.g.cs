...
namespace Polar
{
    public partial class DailyActivityDeprecatedClient
    {
        ...
        private static readonly global::Polar.EndPointSecurityRequirement s_GetStepSamplesAsBytesSecurityRequirement0 =
        ...
        private static readonly global::Polar.EndPointSecurityRequirement[] s_GetStepSamplesAsBytesSecurityRequirements =
            new global::Polar.EndPointSecurityRequirement[]
            {                s_GetStepSamplesAsBytesSecurityRequirement0,
            };
        partial void PrepareGetStepSamplesAsBytesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int userId,
            ref int transactionId,
            ref int activityId);
        partial void PrepareGetStepSamplesAsBytesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int userId,
            int transactionId,
            int activityId);
        partial void ProcessGetStepSamplesAsBytesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetStepSamplesAsBytesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        public async global::System.Threading.Tasks.Task<byte[]> GetStepSamplesAsBytesAsync(
            int userId,
            int transactionId,
            int activityId,
        ...
        {
            var __response = await GetStepSamplesAsBytesAsResponseAsync(
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> GetStepSamplesAsBytesAsStreamAsync(
            int userId,
            int transactionId,
            int activityId,
            global::Polar.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetStepSamplesAsBytesArguments(
            ...
            var __authorizations = global::Polar.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetStepSamplesAsBytesSecurityRequirements,
                operationName: "GetStepSamplesAsBytesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetStepSamplesAsBytesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Polar.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Polar.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetStepSamplesAsBytes",
                                methodName: "GetStepSamplesAsBytesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetStepSamplesAsBytesResponse(
                    httpClient: HttpClient,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Polar.AutoSDKHttpResponse<byte[]>> GetStepSamplesAsBytesAsResponseAsync(
            int userId,
            int transactionId,
            int activityId,
            global::Polar.AutoSDKRequestOptions? requestOptions = default,
                ...
                else
                {
                    await global::Polar.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetStepSamplesAsBytesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
