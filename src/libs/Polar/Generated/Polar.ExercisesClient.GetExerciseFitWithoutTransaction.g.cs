...
namespace Polar
{
    public partial class ExercisesClient
    {
        ...
        private static readonly global::Polar.EndPointSecurityRequirement s_GetExerciseFitWithoutTransactionSecurityRequirement0 =
        ...
        private static readonly global::Polar.EndPointSecurityRequirement[] s_GetExerciseFitWithoutTransactionSecurityRequirements =
            new global::Polar.EndPointSecurityRequirement[]
            {                s_GetExerciseFitWithoutTransactionSecurityRequirement0,
            };
        partial void PrepareGetExerciseFitWithoutTransactionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string exerciseId);
        partial void PrepareGetExerciseFitWithoutTransactionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string exerciseId);
        partial void ProcessGetExerciseFitWithoutTransactionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetExerciseFitWithoutTransactionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        public async global::System.Threading.Tasks.Task<byte[]> GetExerciseFitWithoutTransactionAsync(
            string exerciseId,
            global::Polar.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetExerciseFitWithoutTransactionAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> GetExerciseFitWithoutTransactionAsStreamAsync(
            string exerciseId,
            global::Polar.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetExerciseFitWithoutTransactionArguments(
            ...
            var __authorizations = global::Polar.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetExerciseFitWithoutTransactionSecurityRequirements,
                operationName: "GetExerciseFitWithoutTransactionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetExerciseFitWithoutTransactionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Polar.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Polar.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetExerciseFitWithoutTransactionAsync",
                                pathTemplate: "$\"/v3/exercises/{exerciseId}/fit\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetExerciseFitWithoutTransactionResponse(
                    httpClient: HttpClient,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Polar.AutoSDKHttpResponse<byte[]>> GetExerciseFitWithoutTransactionAsResponseAsync(
            string exerciseId,
            global::Polar.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                ...
                else
                {
                    await global::Polar.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetExerciseFitWithoutTransactionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
