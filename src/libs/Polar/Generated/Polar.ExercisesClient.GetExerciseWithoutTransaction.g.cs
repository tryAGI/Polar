...
namespace Polar
{
    public partial class ExercisesClient
    {
        ...
        private static readonly global::Polar.EndPointSecurityRequirement s_GetExerciseWithoutTransactionSecurityRequirement0 =
        ...
        private static readonly global::Polar.EndPointSecurityRequirement[] s_GetExerciseWithoutTransactionSecurityRequirements =
            new global::Polar.EndPointSecurityRequirement[]
            {                s_GetExerciseWithoutTransactionSecurityRequirement0,
            };
        partial void PrepareGetExerciseWithoutTransactionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string exerciseId,
            ref bool? samples,
            ref bool? zones,
            ref bool? route);
        partial void PrepareGetExerciseWithoutTransactionRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            bool? zones,
            bool? route);
        partial void ProcessGetExerciseWithoutTransactionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetExerciseWithoutTransactionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Polar.ExerciseHashId> GetExerciseWithoutTransactionAsync(
            string exerciseId,
        ...
        {
            var __response = await GetExerciseWithoutTransactionAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Polar.AutoSDKHttpResponse<global::Polar.ExerciseHashId>> GetExerciseWithoutTransactionAsResponseAsync(
            string exerciseId,
            bool? samples = default,
            bool? zones = default,
            bool? route = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetExerciseWithoutTransactionArguments(
            ...
            var __authorizations = global::Polar.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetExerciseWithoutTransactionSecurityRequirements,
                operationName: "GetExerciseWithoutTransactionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetExerciseWithoutTransactionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Polar.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Polar.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetExerciseWithoutTransactionAsync",
                                pathTemplate: "$\"/v3/exercises/{exerciseId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetExerciseWithoutTransactionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Polar.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetExerciseWithoutTransactionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Polar.ExerciseHashId.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Polar.AutoSDKHttpResponse<global::Polar.ExerciseHashId>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Polar.ExerciseHashId.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
