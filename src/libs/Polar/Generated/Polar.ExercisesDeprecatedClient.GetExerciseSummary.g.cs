...
namespace Polar
{
    public partial class ExercisesDeprecatedClient
    {
        ...
        private static readonly global::Polar.EndPointSecurityRequirement s_GetExerciseSummarySecurityRequirement0 =
        ...
        private static readonly global::Polar.EndPointSecurityRequirement[] s_GetExerciseSummarySecurityRequirements =
            new global::Polar.EndPointSecurityRequirement[]
            {                s_GetExerciseSummarySecurityRequirement0,
            };
        partial void PrepareGetExerciseSummaryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int userId,
            ref int transactionId,
            ref int exerciseId);
        partial void PrepareGetExerciseSummaryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int userId,
            int transactionId,
            int exerciseId);
        partial void ProcessGetExerciseSummaryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetExerciseSummaryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get exercise summary<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Polar.Exercise> GetExerciseSummaryAsync(
            int userId,
            int transactionId,
            int exerciseId,
        ...
        {
            var __response = await GetExerciseSummaryAsResponseAsync(
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Polar.AutoSDKHttpResponse<global::Polar.Exercise>> GetExerciseSummaryAsResponseAsync(
            int userId,
            int transactionId,
            int exerciseId,
            global::Polar.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetExerciseSummaryArguments(
            ...
            var __authorizations = global::Polar.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetExerciseSummarySecurityRequirements,
                operationName: "GetExerciseSummaryAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Polar.PathBuilder(
                                path: $"/v3/users/{userId}/exercise-transactions/{transactionId}/exercises/{exerciseId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetExerciseSummaryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Polar.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Polar.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetExerciseSummaryAsync",
                                pathTemplate: "$\"/v3/users/{userId}/exercise-transactions/{transactionId}/exercises/{exerciseId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetExerciseSummaryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Polar.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetExerciseSummaryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Polar.Exercise.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Polar.AutoSDKHttpResponse<global::Polar.Exercise>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Polar.Exercise.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
