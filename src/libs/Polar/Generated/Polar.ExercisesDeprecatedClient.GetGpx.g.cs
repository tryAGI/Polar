...
namespace Polar
{
    public partial class ExercisesDeprecatedClient
    {
        ...
        public async global::System.Threading.Tasks.Task<string> GetGpxAsync(
            int userId,
            int transactionId,
            int exerciseId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Polar.AutoSDKHttpResponse<string>> GetGpxAsResponseAsync(
            int userId,
            int transactionId,
            int exerciseId,
            bool? includePauseTimes = default,
                    ...
                    await global::Polar.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Polar.AutoSDKHttpResponse<string>(
                                        statusCode: __response.StatusCode,
