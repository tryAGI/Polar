...
namespace Polar
{
    public partial class ExercisesDeprecatedClient
    {
        ...
        private static readonly global::Polar.EndPointSecurityRequirement s_GetSamplesSecurityRequirement0 =
        ...
        private static readonly global::Polar.EndPointSecurityRequirement[] s_GetSamplesSecurityRequirements =
            new global::Polar.EndPointSecurityRequirement[]
            {                s_GetSamplesSecurityRequirement0,
            };
        partial void PrepareGetSamplesArguments(
            global::System.Net.Http.HttpClient httpClient,
            byte[] typeId,
            ref int userId,
            ref int transactionId,
            ref int exerciseId);
        partial void PrepareGetSamplesRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int transactionId,
            int exerciseId);
        partial void ProcessGetSamplesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetSamplesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Polar.Sample> GetSamplesAsync(
            byte[] typeId,
            int userId,
            int transactionId,
            int exerciseId,
        ...
        {
            var __response = await GetSamplesAsResponseAsync(
                typeId: typeId,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Polar.AutoSDKHttpResponse<global::Polar.Sample>> GetSamplesAsResponseAsync(
            byte[] typeId,
            int userId,
            int transactionId,
            int exerciseId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Polar.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetSamplesSecurityRequirements,
                operationName: "GetSamplesAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Polar.PathBuilder(
                                path: $"/v3/users/{userId}/exercise-transactions/{transactionId}/exercises/{exerciseId}/samples/{typeId}",
                ...
                else
                {
                    await global::Polar.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetSamplesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Polar.Sample.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Polar.AutoSDKHttpResponse<global::Polar.Sample>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Polar.Sample.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
