...
namespace Polar
{
    public partial class ExercisesDeprecatedClient
    {
        ...
        private static readonly global::Polar.EndPointSecurityRequirement s_GetSamplesAsBytesSecurityRequirement0 =
        ...
        private static readonly global::Polar.EndPointSecurityRequirement[] s_GetSamplesAsBytesSecurityRequirements =
            new global::Polar.EndPointSecurityRequirement[]
            {                s_GetSamplesAsBytesSecurityRequirement0,
            };
        partial void PrepareGetSamplesAsBytesArguments(
            global::System.Net.Http.HttpClient httpClient,
            byte[] typeId,
            ref int userId,
            ref int transactionId,
            ref int exerciseId);
        partial void PrepareGetSamplesAsBytesRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int transactionId,
            int exerciseId);
        partial void ProcessGetSamplesAsBytesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetSamplesAsBytesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        public async global::System.Threading.Tasks.Task<byte[]> GetSamplesAsBytesAsync(
            byte[] typeId,
            int userId,
            int transactionId,
            int exerciseId,
        ...
        {
            var __response = await GetSamplesAsBytesAsResponseAsync(
                typeId: typeId,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> GetSamplesAsBytesAsStreamAsync(
            byte[] typeId,
            int userId,
            int transactionId,
            int exerciseId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSamplesAsBytesArguments(
            ...
            var __authorizations = global::Polar.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetSamplesAsBytesSecurityRequirements,
                operationName: "GetSamplesAsBytesAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Polar.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Polar.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetSamplesAsBytes",
                                methodName: "GetSamplesAsBytesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetSamplesAsBytesResponse(
                    httpClient: HttpClient,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Polar.AutoSDKHttpResponse<byte[]>> GetSamplesAsBytesAsResponseAsync(
            byte[] typeId,
            int userId,
            int transactionId,
            int exerciseId,
                ...
                else
                {
                    await global::Polar.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetSamplesAsBytesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
