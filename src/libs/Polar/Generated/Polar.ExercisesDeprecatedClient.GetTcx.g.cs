...
namespace Polar
{
    public partial class ExercisesDeprecatedClient
    {
        ...
        public async global::System.Threading.Tasks.Task<string> GetTcxAsync(
            int userId,
            int transactionId,
            int exerciseId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Polar.AutoSDKHttpResponse<string>> GetTcxAsResponseAsync(
            int userId,
            int transactionId,
            int exerciseId,
            global::Polar.AutoSDKRequestOptions? requestOptions = default,
