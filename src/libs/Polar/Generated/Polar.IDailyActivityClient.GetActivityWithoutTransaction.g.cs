...
namespace Polar
{
    public partial interface IDailyActivityClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Polar.AutoSDKHttpResponse<global::Polar.ActivitySummaryWithAllSamples>> GetActivityWithoutTransactionAsResponseAsync(
            global::System.DateTime date,
            bool? steps = default,
            bool? activityZones = default,
            bool? inactivityStamps = default,
