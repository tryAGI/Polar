...
namespace Polar
{
    public partial interface IDailyActivityClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Polar.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Polar.ActivitySummaryWithAllSamples>>> ListActivitiesWithoutTransactionByDateRangeAsResponseAsync(
            global::System.DateTime from,
            string from2,
            string to2,
            global::System.DateTime? to = default,
