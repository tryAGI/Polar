...
namespace Polar
{
    public partial interface IElixirTradeBiosensingClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Polar.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Polar.SkinContactPeriod>>> GetUsersBiosensingSkincontactsAsResponseAsync(
            global::System.DateTime? from = default,
            global::System.DateTime? to = default,
            global::Polar.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
