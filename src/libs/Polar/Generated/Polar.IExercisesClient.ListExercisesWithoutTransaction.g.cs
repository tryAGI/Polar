...
namespace Polar
{
    public partial interface IExercisesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Polar.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Polar.ExerciseHashId>>> ListExercisesWithoutTransactionAsResponseAsync(
            bool? samples = default,
            bool? zones = default,
            bool? route = default,
            global::Polar.AutoSDKRequestOptions? requestOptions = default,
