...
{
    /// <summary>
    /// Activity days with all samples.
    /// </summary>
    public sealed partial class ActivitySummaryWithAllSamples
    {
        ...
        public global::Polar.ActivityDayWithSamples? Samples { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivitySummaryWithAllSamples" /> class.
        /// </summary>
...
#endif
        public ActivitySummaryWithAllSamples(
            string? startTime,
            string? endTime,
            ...
            global::Polar.ActivityDayWithSamples? samples)
        {
