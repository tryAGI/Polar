...
namespace Polar
{
    ...
    public sealed partial class WebhookPayloadCircadianBedtime
    {
        ...
        /// </summary>
        /// <example>SLEEP_WISE_CIRCADIAN_BEDTIME</example>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookPayloadCircadianBedtime" /> class.
        /// </summary>
        /// <param name="event">
        /// Type of available data.<br/>
        /// Example: SLEEP_WISE_CIRCADIAN_BEDTIME
...
#endif
        public WebhookPayloadCircadianBedtime(
            string? @event,
            long? userId,
            string? from,
            string? to,
