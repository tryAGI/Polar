...
namespace Polar
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Polar.AutoSDKRetryOptions Retry { get; set; } = new global::Polar.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Polar.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Polar.IAutoSDKHook>();
        ...
        public global::Polar.AutoSDKClientOptions AddHook(
            global::Polar.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Polar.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Polar.AutoSDKClientOptions UseAuthorizationProvider(
            global::Polar.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Polar.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Polar.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Polar.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Polar.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Polar.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Polar.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Polar.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Polar.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Polar.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Polar.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Polar.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Polar.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Polar.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Polar.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Polar.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Polar.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Polar.AutoSDKClientOptions clientOptions,
            global::Polar.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Polar.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Polar.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Polar.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Polar.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Polar.IAutoSDKHook, global::Polar.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Polar.AutoSDKHookContext context)
        {
