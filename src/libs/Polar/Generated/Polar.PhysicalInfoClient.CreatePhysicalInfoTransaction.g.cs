...
namespace Polar
{
    public partial class PhysicalInfoClient
    {
        ...
        private static readonly global::Polar.EndPointSecurityRequirement s_CreatePhysicalInfoTransactionSecurityRequirement0 =
        ...
        private static readonly global::Polar.EndPointSecurityRequirement[] s_CreatePhysicalInfoTransactionSecurityRequirements =
            new global::Polar.EndPointSecurityRequirement[]
            {                s_CreatePhysicalInfoTransactionSecurityRequirement0,
            };
        partial void PrepareCreatePhysicalInfoTransactionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int userId);
        partial void PrepareCreatePhysicalInfoTransactionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int userId);
        partial void ProcessCreatePhysicalInfoTransactionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreatePhysicalInfoTransactionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Polar.TransactionLocation> CreatePhysicalInfoTransactionAsync(
            int userId,
            global::Polar.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreatePhysicalInfoTransactionAsResponseAsync(
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Polar.AutoSDKHttpResponse<global::Polar.TransactionLocation>> CreatePhysicalInfoTransactionAsResponseAsync(
            int userId,
            global::Polar.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreatePhysicalInfoTransactionArguments(
            ...
            var __authorizations = global::Polar.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreatePhysicalInfoTransactionSecurityRequirements,
                operationName: "CreatePhysicalInfoTransactionAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Polar.PathBuilder(
                                path: $"/v3/users/{userId}/physical-information-transactions",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreatePhysicalInfoTransactionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Polar.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Polar.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreatePhysicalInfoTransactionAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreatePhysicalInfoTransactionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Polar.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreatePhysicalInfoTransactionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Polar.TransactionLocation.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Polar.AutoSDKHttpResponse<global::Polar.TransactionLocation>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Polar.TransactionLocation.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
