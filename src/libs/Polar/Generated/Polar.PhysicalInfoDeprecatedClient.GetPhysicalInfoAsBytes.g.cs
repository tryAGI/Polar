...
namespace Polar
{
    public partial class PhysicalInfoDeprecatedClient
    {
        ...
        private static readonly global::Polar.EndPointSecurityRequirement s_GetPhysicalInfoAsBytesSecurityRequirement0 =
        ...
        private static readonly global::Polar.EndPointSecurityRequirement[] s_GetPhysicalInfoAsBytesSecurityRequirements =
            new global::Polar.EndPointSecurityRequirement[]
            {                s_GetPhysicalInfoAsBytesSecurityRequirement0,
            };
        partial void PrepareGetPhysicalInfoAsBytesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int userId,
            ref int transactionId,
            ref int physicalInfoId);
        partial void PrepareGetPhysicalInfoAsBytesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int userId,
            int transactionId,
            int physicalInfoId);
        partial void ProcessGetPhysicalInfoAsBytesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetPhysicalInfoAsBytesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        public async global::System.Threading.Tasks.Task<byte[]> GetPhysicalInfoAsBytesAsync(
            int userId,
            int transactionId,
            int physicalInfoId,
        ...
        {
            var __response = await GetPhysicalInfoAsBytesAsResponseAsync(
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> GetPhysicalInfoAsBytesAsStreamAsync(
            int userId,
            int transactionId,
            int physicalInfoId,
            global::Polar.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetPhysicalInfoAsBytesArguments(
            ...
            var __authorizations = global::Polar.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetPhysicalInfoAsBytesSecurityRequirements,
                operationName: "GetPhysicalInfoAsBytesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetPhysicalInfoAsBytesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Polar.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Polar.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetPhysicalInfoAsBytes",
                                methodName: "GetPhysicalInfoAsBytesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetPhysicalInfoAsBytesResponse(
                    httpClient: HttpClient,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Polar.AutoSDKHttpResponse<byte[]>> GetPhysicalInfoAsBytesAsResponseAsync(
            int userId,
            int transactionId,
            int physicalInfoId,
            global::Polar.AutoSDKRequestOptions? requestOptions = default,
                ...
                else
                {
                    await global::Polar.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetPhysicalInfoAsBytesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
