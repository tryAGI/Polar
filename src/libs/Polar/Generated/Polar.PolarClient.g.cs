...
namespace Polar
{
    ...
    public sealed partial class PolarClient : global::Polar.IPolarClient, global::System.IDisposable
    {
        ...
        /// </summary>
        public CardioLoadClient CardioLoad => new CardioLoadClient(HttpClient, authorizations: Authorizations, options: Options)
        {
        ...
        /// </summary>
        public ContinuousHeartRateClient ContinuousHeartRate => new ContinuousHeartRateClient(HttpClient, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContext = JsonSerializerContext,
        };
        ...
        /// </summary>
        public DailyActivityClient DailyActivity => new DailyActivityClient(HttpClient, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContext = JsonSerializerContext,
        };
        ...
        /// </summary>
        public DailyActivityDeprecatedClient DailyActivityDeprecated => new DailyActivityDeprecatedClient(HttpClient, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContext = JsonSerializerContext,
        };
        ...
        /// </summary>
        public ElixirTradeBiosensingClient ElixirTradeBiosensing => new ElixirTradeBiosensingClient(HttpClient, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContext = JsonSerializerContext,
        };
        ...
        /// </summary>
        public ExercisesClient Exercises => new ExercisesClient(HttpClient, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContext = JsonSerializerContext,
        };
        ...
        /// </summary>
        public ExercisesDeprecatedClient ExercisesDeprecated => new ExercisesDeprecatedClient(HttpClient, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContext = JsonSerializerContext,
        };
        ...
        /// </summary>
        public NightlyRechargeClient NightlyRecharge => new NightlyRechargeClient(HttpClient, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContext = JsonSerializerContext,
        };
        ...
        /// </summary>
        public PhysicalInfoClient PhysicalInfo => new PhysicalInfoClient(HttpClient, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContext = JsonSerializerContext,
        };
        ...
        /// </summary>
        public PullNotificationsClient PullNotifications => new PullNotificationsClient(HttpClient, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContext = JsonSerializerContext,
        };
        ...
        /// </summary>
        public SleepWiseTradeClient SleepWiseTrade => new SleepWiseTradeClient(HttpClient, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContext = JsonSerializerContext,
        };
