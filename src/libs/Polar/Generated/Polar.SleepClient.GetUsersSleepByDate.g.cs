...
namespace Polar
{
    public partial class SleepClient
    {
        ...
        private static readonly global::Polar.EndPointSecurityRequirement s_GetUsersSleepByDateSecurityRequirement0 =
        ...
        private static readonly global::Polar.EndPointSecurityRequirement[] s_GetUsersSleepByDateSecurityRequirements =
            new global::Polar.EndPointSecurityRequirement[]
            {                s_GetUsersSleepByDateSecurityRequirement0,
            };
        partial void PrepareGetUsersSleepByDateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string date);
        partial void PrepareGetUsersSleepByDateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string date);
        partial void ProcessGetUsersSleepByDateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetUsersSleepByDateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Polar.Sleep> GetUsersSleepByDateAsync(
            string date,
            global::Polar.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetUsersSleepByDateAsResponseAsync(
                date: date,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Polar.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Polar.AutoSDKHttpResponse<global::Polar.Sleep>> GetUsersSleepByDateAsResponseAsync(
            string date,
            global::Polar.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetUsersSleepByDateArguments(
            ...
            var __authorizations = global::Polar.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetUsersSleepByDateSecurityRequirements,
                operationName: "GetUsersSleepByDateAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Polar.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Polar.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getUsersSleepByDate",
                                methodName: "GetUsersSleepByDateAsync",
                                pathTemplate: "$\"/v3/users/sleep/{date}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetUsersSleepByDateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Polar.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetUsersSleepByDateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Polar.Sleep.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Polar.AutoSDKHttpResponse<global::Polar.Sleep>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Polar.Sleep.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
